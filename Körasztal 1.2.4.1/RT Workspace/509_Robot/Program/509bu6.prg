...
95 'Értékadások
96 '***************************************************************************
97 mcmd_num=M_Inw(10160)          'parancsszám beolvasása
...
116         mcmd=M_Inw(10176)                                   'parancs beolvasása
117         For mi=1 To 10
118             mpa(mi)=M_Inw(10176+mi*16)                 'paraméterek beolvasása
119         Next mi
120     '
121         mstate=1
...
128          For mi=1 To 9
129              M_Outw(10192+mi*16)=mres(mi)            'eredmények visszaküldése
130          Next mi
131          M_Outw(10192)=mcode                               'hibakód visszaküldése
132          M_Outw(10176)=mcmd                                'parancs visszaküldése
133          M_Outw(10160)=mcmd_num                        'parancsszám visszaküldése
134          Dly 0.1
135          mfinish=0
136          mcmd=0
137          mstate=0
...
578     Mov Pfeszek,-150
579     Mov PHome
580     Mvs Phajl2_elott
581     Cnt 0
582     Fine 100
583     Mvs Phajl2berak_k
584     Fine 0
585     mcode=0
586     mfinish=1
587 '
...
prout(10)=(+374.63,+50.74,+599.43,-148.42,+75.12,-148.08,+0.00,+0.00)(6,0)
prout(11)=(+374.63,+50.74,+599.43,-148.42,+75.12,-148.08,+0.00,+0.00)(6,0)
...
Plakkozo2_k=(+520.99,+49.36,+566.62,-148.42,+75.12,-148.08)(6,0)
...
Plakkozo2_elott=(+374.63,+50.74,+599.43,-148.42,+75.12,-148.08)(6,0)
