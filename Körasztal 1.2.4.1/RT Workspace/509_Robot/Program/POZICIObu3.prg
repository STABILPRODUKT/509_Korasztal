...
21 mpoz=8
22 EndIf
23 If Dist(P_Curr,P_lakkozo2)<=0.1 Or Dist(P_Curr,P_lakkozo2_uj)<=0.1 Then
24 mpoz=10
25 EndIf
26 If Dist(P_Curr,P_szalag_uj)<=0.1 Then
27 mpoz=12
28 EndIf
29 If Dist(P_Curr,P_szfelett_uj)<=0.1 Then
30 mpoz=13
31 EndIf
32 If Dist(P_Curr,P_service1)<=0.1 Then
33 mpoz=14
34 EndIf
35 If Dist(P_Curr,P_service2)<=0.1 Then
36 mpoz=15
37 EndIf
38 M_Outw(10480)=mpoz
